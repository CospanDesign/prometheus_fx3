...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0x00,                           /* Max power consumption of device (in 8mA unit) : 400mA */
    ...
    /* Endpoing descriptor for Debug Consumer EP */
    0x07,                           /* Descriptor size */
    CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
    CY_FX_EP_DEBUG_OUT,             /* Endpoint address and description */
    CY_U3P_USB_EP_INTR,             /* Interrupt endpoint type */
    0x80,0x00,                      /* Max packet size = 1024 bytes */
    0x01,                           /* Servicing interval for data transfers : 1 every micro second */
    ...
    0x80,0x00,                      /* Service interval for the EP : 128 bytes */

    /* Endpoing descriptor for Debug Consumer EP */
    0x07,                           /* Descriptor size */
    CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint descriptor type */
    CY_FX_EP_DEBUG_IN,              /* Endpoint address and description */
    CY_U3P_USB_EP_INTR,             /* Interrupt endpoint type */
    0x80,0x00,                      /* Max packet size = 1024 bytes */
    0x01,                           /* Servicing interval for data transfers : 1 every micro second */
...
const uint8_t CyFxUSBHSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0x09,                           /* Descriptor size */
    CY_U3P_USB_CONFIG_DESCR,        /* Configuration descriptor type */
    0x37,0x00,                      /* Length of this descriptor and all sub descriptors */
    0x02,                           /* Number of interfaces */
    0x01,                           /* Configuration number */
    0x00,                           /* COnfiguration string index */
    0xE0,                           /* Config characteristics - bus powered */
    0x00,                           /* Max power consumption of device (in 2mA unit) : 100mA */
    ...
    CY_FX_EP_DEBUG_OUT,             /* Endpoint address and description */
    CY_U3P_USB_EP_INTR,             /* Interrupt endpoint type */
    0x80,0x00,                      /* Max packet size = 512 bytes */
    0x01,                           /* Servicing interval for data transfers : 1 every micro second */
